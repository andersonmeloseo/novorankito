...
export const SCHEMA_TYPES: Record<string, string[]> = {
  ...
  evento: ["Event", "BusinessEvent"],
  faq: ["FAQPage"],
  artigo: ["Article", "BlogPosting", "NewsArticle"],
  oferta: ["Offer", "AggregateOffer"],
  marca: ["Brand"],
  categoria: ["Thing", "CategoryCode"],
  imagem: ["ImageObject"],
  credencial: ["EducationalOccupationalCredential"],
  pagina: ["WebPage", "AboutPage", "ContactPage"],
  busca: ["SearchAction"],
  pergunta: ["Question"],
  horario: ["OpeningHoursSpecification"],
  geo: ["GeoCoordinates"],

...
const SCHEMA_DIDACTICS: Record<string, string> = {
  Thing: "🔹 O que é: A raiz de todos os tipos Schema.org. Tudo herda de Thing. 🔹 Por que usar: Raramente usado diretamente — prefira um tipo mais específico. Serve como fallback quando nenhuma categoria se encaixa. 🔹 Quando usar: Quase nunca de forma direta.",
  CreativeWork: "🔹 O que é: Representa qualquer obra criativa — artigos, vídeos, livros, podcasts, músicas. 🔹 Por que usar: O Google usa para entender autoria e tipo de conteúdo, melhorando visibilidade na busca. 🔹 Quando usar: Sempre que publicar conteúdo original (blog, vídeo, ebook). Prefira subtipos como Article ou VideoObject.",
  Article: "🔹 O que é: Um artigo publicado — blog post, artigo técnico, editorial. 🔹 Por que usar: Gera Rich Results com data, autor e imagem no Google. Aumenta CTR em até 30%. 🔹 Quando usar: Em TODA página de artigo ou blog post do seu site. É um dos schemas mais importantes para sites de conteúdo.",
  BlogPosting: "🔹 O que é: Subtipo de Article específico para posts de blog. 🔹 Por que usar: Sinaliza ao Google que é conteúdo de blog, diferenciando de notícias. Ativa Rich Results de artigo. 🔹 Quando usar: Em posts de blog com data de publicação e autor. Se tiver um blog, use em TODAS as páginas de post.",
  NewsArticle: "🔹 O que é: Artigo jornalístico ou notícia. 🔹 Por que usar: Qualifica seu conteúdo para aparecer no Google News e Top Stories — posição privilegiada nos resultados. 🔹 Quando usar: SOMENTE se você é veículo de mídia ou publica notícias. Não use para blog posts comuns.",
  WebPage: "🔹 O que é: Representa uma página web individual. 🔹 Por que usar: Ajuda o Google a entender a estrutura do site e o propósito de cada página. 🔹 Quando usar: Opcional para páginas genéricas. Prefira tipos mais específicos como FAQPage, CollectionPage ou AboutPage.",
  WebSite: "🔹 O que é: Representa o site como um todo (não uma página individual). 🔹 Por que usar: Ativa o Sitelinks Search Box — a caixa de busca que aparece diretamente nos resultados do Google. 🔹 Quando usar: Uma vez, na homepage. Inclua sempre o SearchAction para busca interna.",
  FAQPage: "🔹 O que é: Página de perguntas frequentes. 🔹 Por que usar: Gera Rich Results de FAQ — suas perguntas e respostas aparecem diretamente no Google, ocupando mais espaço visual e aumentando CTR. 🔹 Quando usar: Em qualquer página com perguntas e respostas. Ideal para páginas de produto, serviço ou suporte.",
  HowTo: "🔹 O que é: Tutorial passo a passo. 🔹 Por que usar: Gera Rich Results de 'Como fazer' com passos numerados no Google. Excelente para capturar buscas informacionais. 🔹 Quando usar: Em tutoriais, guias e conteúdo educativo com etapas claras.",
  Review: "🔹 O que é: Uma avaliação individual de produto, serviço ou negócio. 🔹 Por que usar: Gera estrelas de avaliação nos resultados — um dos Rich Results com maior impacto no CTR. 🔹 Quando usar: Em páginas de reviews, depoimentos ou avaliações de clientes.",
  Recipe: "🔹 O que é: Receita culinária com ingredientes e modo de preparo. 🔹 Por que usar: Gera Rich Results visuais com foto, tempo, calorias e ingredientes. Um dos schemas mais ricos visualmente. 🔹 Quando usar: Em TODA receita publicada. Se tem site de receitas, é obrigatório.",
  VideoObject: "🔹 O que é: Um vídeo publicado online (YouTube, Vimeo ou hospedagem própria). 🔹 Por que usar: Gera miniatura de vídeo nos resultados de busca — altamente chamativo e aumenta CTR. 🔹 Quando usar: Em qualquer página que contenha um vídeo principal. Essencial para canais e produtores de conteúdo.",
  ImageObject: "🔹 O que é: Uma imagem com metadados estruturados. 🔹 Por que usar: Otimiza a imagem para Google Imagens e ajuda na indexação visual do conteúdo. 🔹 Quando usar: Em galerias, portfolios ou quando a imagem é o conteúdo principal da página.",
  Product: "🔹 O que é: Um produto à venda em e-commerce. 🔹 Por que usar: Gera Rich Results com preço, disponibilidade, avaliações e imagem — ESSENCIAL para e-commerce. Aumenta CTR e conversões. 🔹 Quando usar: Em TODA página de produto de loja online. Obrigatório para e-commerce.",
  Offer: "🔹 O que é: Uma oferta comercial (preço + disponibilidade) vinculada a um Product. 🔹 Por que usar: Sem Offer, o Google não exibe preço nos Rich Results do produto. 🔹 Quando usar: Sempre dentro de Product. Inclua price, priceCurrency e availability.",
  Organization: "🔹 O que é: Uma empresa, ONG, instituição ou organização. 🔹 Por que usar: Alimenta o Knowledge Panel do Google — aquele painel lateral com informações da empresa. Fundamental para branding. 🔹 Quando usar: Na homepage ou página 'Sobre'. Toda empresa deveria ter.",
  Corporation: "🔹 O que é: Subtipo de Organization para empresas de capital aberto. 🔹 Por que usar: Inclui dados como tickerSymbol (código na bolsa). Gera informações financeiras no Knowledge Panel. 🔹 Quando usar: SOMENTE para empresas listadas em bolsa de valores.",
  LocalBusiness: "🔹 O que é: Negócio com endereço físico que atende clientes presencialmente. 🔹 Por que usar: FUNDAMENTAL para SEO local. Ativa Rich Results com endereço, telefone, horários e avaliações. Aparece no Google Maps. 🔹 Quando usar: OBRIGATÓRIO para qualquer negócio com ponto físico — restaurantes, lojas, clínicas, escritórios.",
  Restaurant: "🔹 O que é: Restaurante, bar, café ou lanchonete. 🔹 Por que usar: Ativa Rich Results específicos com cardápio, tipo de cozinha, reservas e avaliações. 🔹 Quando usar: Para QUALQUER estabelecimento que serve comida ou bebida. Use em vez de LocalBusiness genérico.",
  Store: "🔹 O que é: Loja física de varejo. 🔹 Por que usar: Melhora visibilidade no Google Maps e busca local com horários e localização. 🔹 Quando usar: Para lojas de roupas, eletrônicos, supermercados ou qualquer comércio varejista com ponto físico.",
  MedicalBusiness: "🔹 O que é: Clínica, consultório, hospital ou laboratório. 🔹 Por que usar: Ativa informações de saúde com especialidades médicas e aceitação de pacientes. Google dá destaque especial a negócios de saúde. 🔹 Quando usar: Para qualquer negócio da área de saúde.",
  Person: "🔹 O que é: Uma pessoa real e identificável (autor, CEO, especialista). 🔹 Por que usar: Constrói E-E-A-T (Experiência, Expertise, Autoridade, Confiança). O Google associa conteúdo a autores reais, favorecendo nos resultados. 🔹 Quando usar: Para autores de artigos, fundadores, especialistas. Essencial para construir autoridade pessoal.",
  Event: "🔹 O que é: Um evento com data, local e ingressos. 🔹 Por que usar: Gera Rich Results de eventos no Google com data, local e botão de ingresso. 🔹 Quando usar: Para conferências, workshops, shows, webinars ou qualquer evento com data definida.",
  MusicEvent: "🔹 O que é: Show, festival ou evento musical. 🔹 Por que usar: Inclui artistas/bandas, venda de ingressos e local. Muito buscado no Google. 🔹 Quando usar: Para shows, festivais e eventos musicais com lineup de artistas.",
  Course: "🔹 O que é: Curso online ou presencial. 🔹 Por que usar: Gera Rich Results com provedor, preço e descrição do curso. Essencial para infoprodutores e escolas online. 🔹 Quando usar: Em TODA página de venda de curso ou treinamento.",
  JobPosting: "🔹 O que é: Vaga de emprego publicada online. 🔹 Por que usar: Aparece no Google Jobs — plataforma integrada de vagas do Google. Enorme potencial de tráfego. 🔹 Quando usar: Em TODA página de vaga de emprego. Se sua empresa contrata, é obrigatório.",
  Place: "🔹 O que é: Um lugar genérico (parque, praça, monumento). 🔹 Por que usar: Base para tipos mais específicos. Ajuda o Google a entender localização. 🔹 Quando usar: Somente quando não existe tipo mais específico (prefira LocalBusiness, Restaurant, etc.).",
  PostalAddress: "🔹 O que é: Endereço postal com rua, cidade, estado e CEP. 🔹 Por que usar: Estrutura o endereço para que o Google entenda cada campo. Essencial para SEO local. 🔹 Quando usar: SEMPRE dentro de LocalBusiness ou Organization. Nunca sozinho.",
  GeoCoordinates: "🔹 O que é: Coordenadas de latitude e longitude. 🔹 Por que usar: Permite ao Google posicionar seu negócio com precisão no mapa. 🔹 Quando usar: Dentro de LocalBusiness junto com PostalAddress para máxima precisão.",
  BreadcrumbList: "🔹 O que é: A trilha de navegação (ex: Home > Produtos > Smartphones). 🔹 Por que usar: Exibe a hierarquia de navegação diretamente nos resultados do Google, melhorando usabilidade e CTR. 🔹 Quando usar: Em TODAS as páginas do site. Um dos schemas mais fáceis de implementar e com ótimo retorno.",
  ItemList: "🔹 O que é: Uma lista ordenada de itens (top 10, melhores X). 🔹 Por que usar: Gera Carousel Rich Results — múltiplos resultados do seu site ocupando um carrossel inteiro no Google. 🔹 Quando usar: Em listas comparativas, rankings, 'melhores de' ou páginas de categoria.",
  SoftwareApplication: "🔹 O que é: Aplicativo mobile, web ou desktop. 🔹 Por que usar: Gera Rich Results com nota, preço e sistema operacional. 🔹 Quando usar: Na página de download ou apresentação do seu app/software.",
  Brand: "🔹 O que é: Uma marca comercial identificável. 🔹 Por que usar: Ajuda o Google a associar produtos à marca correta. Melhora Knowledge Panel. 🔹 Quando usar: Dentro de Product, usando brand.name para identificar o fabricante.",
  ContactPoint: "🔹 O que é: Um ponto de contato (telefone, e-mail, suporte). 🔹 Por que usar: Exibe informações de contato no Knowledge Panel. Facilita que clientes encontrem como falar com você. 🔹 Quando usar: Dentro de Organization ou LocalBusiness com tipo de contato (vendas, suporte, etc.).",
  Action: "🔹 O que é: Ação abstrata que pode ser realizada por um agente. 🔹 Por que usar: Base para ações específicas como busca, compra ou inscrição. Geralmente não usada diretamente. 🔹 Quando usar: Prefira subtipos como SearchAction ou BuyAction.",
  SearchAction: "🔹 O que é: Ação de busca interna no site. 🔹 Por que usar: Ativa o Sitelinks Search Box — a caixa de pesquisa que aparece dentro dos resultados do Google para seu site. 🔹 Quando usar: SEMPRE dentro de WebSite na homepage. Se seu site tem busca interna, é obrigatório.",
  Intangible: "🔹 O que é: Categoria para coisas que não são físicas (ofertas, serviços, permissões). 🔹 Por que usar: Não usado diretamente. Base abstrata para Offer, Service, etc. 🔹 Quando usar: Nunca diretamente — use os subtipos específicos.",
  Service: "🔹 O que é: Um serviço profissional (consultoria, design, jurídico). 🔹 Por que usar: Descreve serviços com área de atuação, provedor e preço. Ajuda o Google a entender o que sua empresa oferece. 🔹 Quando usar: Em páginas de serviços profissionais (consultoria, marketing, advocacia).",
  AggregateRating: "🔹 O que é: A nota média de todas as avaliações (ex: 4.5 de 5, baseado em 89 reviews). 🔹 Por que usar: Gera as famosas ⭐ estrelas nos resultados do Google — um dos maiores impulsionadores de CTR. 🔹 Quando usar: Dentro de Product, LocalBusiness ou Organization. Necessário ter avaliações reais.",
  Dataset: "🔹 O que é: Um conjunto de dados estruturado (pesquisa, estatísticas, dados públicos). 🔹 Por que usar: Aparece no Google Dataset Search, útil para pesquisadores e data scientists. 🔹 Quando usar: Para dados públicos, pesquisas acadêmicas ou estatísticas publicadas.",
  SpeakableSpecification: "🔹 O que é: Marca trechos de texto otimizados para leitura por assistentes de voz. 🔹 Por que usar: Google Assistant pode ler seu conteúdo em voz alta como resposta. Posiciona para busca por voz. 🔹 Quando usar: Em artigos de notícias ou conteúdo informativo que responde perguntas diretas.",
  CollectionPage: "🔹 O que é: Página que agrupa múltiplos itens (categoria, listagem). 🔹 Por que usar: Ajuda o Google a entender a hierarquia do site e indexar páginas de categoria. 🔹 Quando usar: Em páginas de categorias de blog, listagem de produtos ou seções do site.",
  ProfilePage: "🔹 O que é: Página de perfil de uma pessoa ou organização. 🔹 Por que usar: Fortalece E-E-A-T ao vincular autoria a um perfil verificável. O Google recomenda para autores. 🔹 Quando usar: Em páginas de perfil de autores, especialistas ou página 'Equipe' da empresa.",
};

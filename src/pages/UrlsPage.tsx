...
export default function UrlsPage() {
  ...
  return (
    <>
      <TopBar title="URLs" subtitle="Sitemap & Inventory" />
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-border bg-muted/30">
                  ...
                  <th className="px-4 py-3 text-left text-xs font-medium text-muted-foreground">Last Crawl</th>
              ...
              <Tabs defaultValue="seo" className="mt-6">
                ...
                <TabsContent value="seo" className="mt-4 space-y-4">
                  <div className="grid grid-cols-2 gap-3">
                    <MiniKpi icon={MousePointerClick} label="Clicks" value="3,842" change={12.4} />
                    <MiniKpi icon={Eye} label="Impressions" value="98,420" change={8.1} />
                    <MiniKpi icon={TrendingUp} label="CTR" value="3.9%" change={3.2} />
                    <MiniKpi icon={ArrowUpDown} label="Position" value="4.2" change={-1.2} />
                  </div>
                  <Card className="p-4">
                    <h4 className="text-xs font-medium text-muted-foreground mb-3">Top Queries</h4>
                ...
                <TabsContent value="analytics" className="mt-4 space-y-4">
                  <div className="grid grid-cols-2 gap-3">
                    <MiniKpi icon={Eye} label="Users" value="1,240" change={15.2} />
                    <MiniKpi icon={TrendingUp} label="Sessions" value="1,890" change={9.7} />
                  </div>
                </TabsContent>
                <TabsContent value="tracking" className="mt-4 space-y-4">
                  <Card className="p-4 text-center text-xs text-muted-foreground">
                    No tracking events yet. Install the Rankito script to start collecting data.
                  </Card>
                </TabsContent>
              </Tabs>
            </>
